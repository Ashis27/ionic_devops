...
@IonicPage()
@Component({
  selector: 'page-seealllabprofile',
  templateUrl: 'seealllabprofile.html',
  providers: [CallNumber,InAppBrowser]
})
export class SeeAllLabProfile {
                ...
                .then((result) => {
                  ...
                  this.commonService.getStoreDataFromCache(this.commonService.getCacheKeyUrl("getCurrentCityFromGPS"))
                    .then((response) => {
                      ...
                      this._dataContext.GetLabProfile(query)
                        .subscribe(response => {
                          if (response.hits.total > 0) {
                            ...
                            this.labProfileList = this.labProfileList.concat(response.hits.hits);
                            ...
                            this.page = this.labProfileList.length;
